...
const classButtomBack =`bg-violet-900
  my-3 text-white font-bold uppercase p-3  mx-4 self-start lg:w-20
 hover:bg-violet-700 transition-colors rounded-lg` ;

const classImg = `w-full  p-2 md:w-3/4 h-96 lg:h-[480px] rounded-lg mx-auto`;
